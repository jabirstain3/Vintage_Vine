...
const SignUpPage = () => {
    ...
    const { createUser, gooleCreateUser, /*facebookCreateUser*/ }= useContext( AuthContext);
    ...
    return (
            <div className="w-full h-screen flex justify-center items-center ">
                ...
                <div className="w-[300px] sm:w-[525px] rounded-2xl sm:rounded-3xl py-[40px] sm:py-[60px] px-10 sm:px-14 grid justify-center bg-primary" >
                    <h1 className="text-center font-bold text-2xl sm:text-5xl mb-8 sm:mb-10">SIGN UP</h1>

                    <form className="grid items-center" onSubmit={handelSignUp}>
                        <input name="username" type="text" placeholder="UserName..." className="w-[256px] sm:w-[360px] h-fit rounded-md mb-4 px-3 sm:px-4 py-1 sm:py-2 text-md sm:text-xl" required/>
                        ...
                        <input name="mobile" type="tel" placeholder="Phone Number..." className="w-[256px] sm:w-[360px] h-fit rounded-md mb-4 px-3 sm:px-4 py-1 sm:py-2 text-md sm:text-xl" />
                        ...
                        <div className="relative mb-2">
                            <input className="w-[256px] sm:w-[360px] h-fit rounded-md px-2 sm:px-4 py-1 sm:py-2 text-md sm:text-xl"  type={show ? 'text' : 'password'} name="retypePassword" placeholder="Retype Password..." required />
                            <span className='absolute top-2 sm:top-3 right-2 cursor-default text-xs sm:text-sm' onClick={() => setShow(!show)}>{ show ? "hide" : "show"}</span>
                        </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <span className="px-2 sm:px-3  text-xs sm:text-md">Or Sign Up with</span>
                        <div className="border-t border-black flex-grow"></div>
                    </div>
                    ...
                    <p className=" text-center text-sm sm:text-lg">Already Have an account? <NavLink className={'hover:text-black '} to={'/login'}>Log In</NavLink></p>
